...
let githubLink = "http://github.com/frankshearar/etwas"

// Specify more information about your project
let info =
  [ "project-name", "etwas"
    "project-author", "Frank Shearar"
    "project-summary", "Publish ETW events to all the places."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/etwas" ]
